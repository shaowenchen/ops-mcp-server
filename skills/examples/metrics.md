...
```bash
# List all metrics
mcporter call ops-mcp-server-mcp list-metrics-from-prometheus

# Search for specific metrics
mcporter call ops-mcp-server-mcp list-metrics-from-prometheus search="cpu" limit="50"
```
...
```bash
# Simple metric query
mcporter call ops-mcp-server-mcp query-metrics-from-prometheus query="up"

# Filtered query
mcporter call ops-mcp-server-mcp query-metrics-from-prometheus query='up{job="kubernetes-nodes"}'

# Aggregated query
mcporter call ops-mcp-server-mcp query-metrics-from-prometheus query="sum(node_memory_MemTotal_bytes)"
```
...
mcporter call ops-mcp-server-mcp query-metrics-range-from-prometheus \
...
```bash
# CPU usage
mcporter call ops-mcp-server-mcp query-metrics-from-prometheus \
...
mcporter call ops-mcp-server-mcp query-metrics-range-from-prometheus query="up" time_range="1h"
```
