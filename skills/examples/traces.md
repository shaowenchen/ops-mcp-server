...
```bash
# List all services
mcporter call ops-mcp-server-mcp get-services-from-jaeger
```
...
```bash
# Get all operations
mcporter call ops-mcp-server-mcp get-operations-from-jaeger service="api-gateway"

# Filter by span kind
mcporter call ops-mcp-server-mcp get-operations-from-jaeger service="user-service" spanKind="server"
```
...
```bash
# Find recent traces
mcporter call ops-mcp-server-mcp find-traces-from-jaeger \
...
```bash
# Get trace by ID
mcporter call ops-mcp-server-mcp get-trace-from-jaeger traceId="abc123def456789012345678901234"

# Get trace with time filter
mcporter call ops-mcp-server-mcp get-trace-from-jaeger \
...
mcporter call ops-mcp-server-mcp get-operations-from-jaeger service="payment-service"
...
# Analyze failure
mcporter call ops-mcp-server-mcp get-trace-from-jaeger traceId="def789abc123456789012345678901234"
```
...
mcporter call ops-mcp-server-mcp get-operations-from-jaeger service="api-gateway" spanKind="server"
```
...
mcporter call ops-mcp-server-mcp get-operations-from-jaeger service="api-gateway" spanKind="client"
```
...
mcporter call ops-mcp-server-mcp get-operations-from-jaeger service="payment-service" spanKind="internal"
```
