...
```bash
# List all indices
mcporter call ops-mcp-server-mcp list-log-indices-from-elasticsearch

# Filter by health status
mcporter call ops-mcp-server-mcp list-log-indices-from-elasticsearch health="green" format="table"

# Get open indices in JSON
mcporter call ops-mcp-server-mcp list-log-indices-from-elasticsearch status="open" format="json"
```
...
```bash
# Simple search
mcporter call ops-mcp-server-mcp search-logs-from-elasticsearch \
...
```bash
# Basic ES|QL query
mcporter call ops-mcp-server-mcp query-logs-from-elasticsearch \
